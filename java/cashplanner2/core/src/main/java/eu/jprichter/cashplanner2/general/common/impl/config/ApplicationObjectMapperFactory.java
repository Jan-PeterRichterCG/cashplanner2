package eu.jprichter.cashplanner2.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the cashplanner2 application.
 */
